...
class DeafApplication:
    ...
    def action_call(self) :
        ...
        self.photo1 = tk.PhotoImage(file='Pictures/Avtar_Chandra.png')
        ...
        self.tx6.config(text = "Avtar_Chandra\n2104754", font = ("Courier",15,"bold"))

        self.photo2 = tk.PhotoImage(file='Pictures/photo.png')
        ...
        self.photo3 = tk.PhotoImage(file='Pictures/photo.png')
        ...
        self.photo4 = tk.PhotoImage(file='Pictures/photo.png')
        ...
        self.photo5 = tk.PhotoImage(file='Pictures/photo.png')
        ...
        self.photo6 = tk.PhotoImage(file='Pictures/shiv_prakash.png')
        self.w6 = tk.Label(self.root1, image = self.photo6)
        self.w6.place(x = 350, y = 420)
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x = 230,y = 670)
        self.tx6.config(text = "Prof. Shiv Prakash", font = ("Courier",30,"bold"))

print("Starting DeafApplication...")
pba = DeafApplication()
pba.root.mainloop()
